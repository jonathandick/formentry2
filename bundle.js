...
function questionsToFormlyFields(questions,fields,model,questionMap) {
    for(var i in questions) {
        ...
        fields.push(field);
        if("questions" in question) {
            questionsToFormlyFields(question.questions,fields,field.recursiveModel,questionMap);
		}
...
function insertIntoFormlyFields(index,question,fields,model,questionMap) {
    ...
    if ("questions" in question) {
        ...
        var nestedFields = [];
        questionsToFormlyFields(question.questions, nestedFields, field.recursiveModel, questionMap);
